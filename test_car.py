...
class TestCalliope(unittest.TestCase):
    '''
    Testing the battery using three different years: 1, 2, 3
    '''
    ...
    def test_battery_should_not_be_serviced(self):
        ...
        car = CarFactory.create_calliope(today, last_service_date, current_mileage, last_service_mileage)
        car.battery.last_service_date = today.replace(year=today.year - 1)
        self.assertFalse(car.needs_service())

        car.battery.last_service_date = today.replace(year=today.year - 2)
        self.assertFalse(car.needs_service())
    ...
    def test_engine_should_not_be_serviced(self):
        ...
        car = CarFactory.create_calliope(today, last_service_date, current_mileage, last_service_mileage)
        self.assertFalse(car.needs_service())
        car.engine.current_mileage = 29000
        self.assertFalse(car.needs_service())
